...
public class RestActor extends Actor {
    ...
    public void getResource(String url) {
        try {
            HtmlReport.writeToHtmlReport("GET from url:" + url + ":");
...
//    /**
//     * The API actor uses different properties (so that we can pint the test at the API just by changing the defaultBrowser in the framework properties)
//     *
...
//        return ContextOfTest.sutConfiguration.getProperty("defaultApiProtocol") + "://" + ContextOfTest.sutConfiguration.getProperty("defaultApiDomainName");
//    }
