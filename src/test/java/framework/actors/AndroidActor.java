...
public class AndroidActor extends Actor {
    ...
    protected void createDriver() {
        ...
        try {
            ...
            String myBrowserName = ContextOfTest.testConfiguration.getProperty("defaultBrowser");
            ...
            capabilities.setCapability("platformName", ContextOfTest.testConfiguration.getProperty("defaultBrowser"));
        ...
        driver.manage().timeouts().implicitlyWait(ContextOfTest.pageLoadWait, TimeUnit.SECONDS);
    }
}